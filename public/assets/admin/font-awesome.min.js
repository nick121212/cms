 ...
 *  License - http://fontawesome.io/license (Font: SIL OFL 1.1, CSS: MIT License)
  ...
  'fa-lg': {
    'fontSize': [{ 'unit': 'em', 'value': 1.33333333 }],
  ...
  'fa-fw': {
    'width': [{ 'unit': 'em', 'value': 1.28571429 }],
    'textAlign': 'center'
  },
  'fa-ul': {
    'paddingLeft': [{ 'unit': 'px', 'value': 0 }],
    'marginLeft': [{ 'unit': 'em', 'value': 2.14285714 }],
    'listStyleType': 'none'
  },
  'fa-ul>li': {
    'position': 'relative'
  ...
  'fa-li': {
    'position': 'absolute',
    'left': [{ 'unit': 'em', 'value': -2.14285714 }],
    'width': [{ 'unit': 'em', 'value': 2.14285714 }],
    'top': [{ 'unit': 'em', 'value': 0.14285714 }],
    'textAlign': 'center'
  },
  'fa-lifa-lg': {
    'left': [{ 'unit': 'em', 'value': -1.85714286 }]
  },
  'fa-border': {
    'padding': [{ 'unit': 'em', 'value': 0.2 }, { 'unit': 'em', 'value': 0.25 }, { 'unit': 'em', 'value': 0.15 }, { 'unit': 'em', 'value': 0.25 }],
    'border': [{ 'unit': 'string', 'value': 'solid' }, { 'unit': 'em', 'value': 0.08 }, { 'unit': 'string', 'value': '#eee' }],
    'borderRadius': '.1em'
  },
  'fa-pull-left': {
    'float': 'left'
